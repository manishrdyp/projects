...
<body  id="body" class="">
        ...
        <div class="flex justify-center border-rose-500">
            <div class="h-[90%] w-full md:w-3/4 m-4">
                ...
                <a href="index.php"><button id="c_n_a" class="uppercase px-5 py-2 rounded-md text-white bg-blue-500 hover:bg-black  font-medium">login</button></a>
                </div>
            </form>
                <div class="text-xl cursor-pointer flex flex-col justify-center items-center mt-5 " >
                    <div id="c_n_a" class="text-black font-semibold">or</div>
                </div>
                <div class="text-center my-6 flex flex-col " style="margin-left: 20px;">
                    <a href="Signup.php" id="c_n_a" class="text-l font-bold text-black hover:ring-sky-500 m-1">Create New Account</a>
                </div>
            </div>
        </div>
    </div>
