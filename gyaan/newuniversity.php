  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		{ 
			...
			//save to database
			$query = "insert into university (name, Description, owner_name, location,courses, degree,image) values ('$name','$description','$o_name','$location','$courses','$degree','$filename')";

			mysqli_query($con, $query);

			header("Location: myuniversity.php");
			die;
		}else
		{
          ...
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <div class="flex border-t border-black py-2">
                ...
                <span class="ml-auto text-black"><input type="text" name="courses"></span>
              </div>
              <div class="flex border-t border-b mb-6 border-black py-2">
                <span class="text-black">Degrees</span>
                <span class="ml-auto text-black"><input type="text" name="degree"></span>
              </div>
